...
m.rawhtml  = true
if redir_run == 1 then
	m.value =font_blue  .. translate("ShadowSocksR is Running") ..  font_off
else 
if v2ray_run == 1 then
	m.value =font_blue  .. translate("V2ray is Running") ..  font_off
else
	m.value =font_red  .. translate("NOT Running") ..  font_off
end
end
...
if tunnel_run == 1 then
	m.value =font_green..  translate("ssr-tunnel") ..  font_off
end

if pdnsd == 1 then
	m.value =font_green ..  translate("pdnsd") ..  font_off
end

if dns2 == 1 then
	m.value =font_green ..  translate("dns2socks") ..  font_off
end

if pcap == 1 then
	m.value =font_green ..  translate("Pcap_DNSProxy") ..  font_off
end
if dnsproxy == 1 then
	m.value =font_green ..  translate("dnsproxy ") ..  font_off
end
