...
-- [[ Servers Setting ]]--
sec = m:section(TypedSection, "servers", translate("SSR Servers list"))
sec.anonymous = true
sec.addremove = true
sec.sortable = true
...
-- [[ Servers Setting ]]--
sec = m:section(TypedSection, "servers_v2", translate("V2ray Servers Setting"))
sec.anonymous = true
sec.addremove = true
sec.sortable = true
sec.template = "cbi/tblsection"
...
o = sec:option(DummyValue, "security", translate("Encrypt Method"))
function o.cfgvalue(...)
	return Value.cfgvalue(...) or "?"
end

o = sec:option(DummyValue, "alter_id", translate("alter_id"))
function o.cfgvalue(...)
	return Value.cfgvalue(...) or "0"
end


o = sec:option(DummyValue, "transport", translate("Protocol"))
function o.cfgvalue(...)
	return Value.cfgvalue(...) or "?"
end
